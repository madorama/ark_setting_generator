			...
			[
				...
				_List_fromArray(
					[
						...
						_List_Nil),
						$miyamoen$elm_origami$Origami$Html$text('スタックサイズ倍率を無視する')
					]))
			]));
};
